...
def main():
    ...
    try:
        ...
        utils.save_checkpoint(net_g, optim_g, hps.train.learning_rate, epoch, os.path.join(hps.model_dir, f"G_latest.pth"))
        utils.save_checkpoint(net_d, optim_d, hps.train.learning_rate, epoch, os.path.join(hps.model_dir, f"D_latest.pth"))
        logger.info(f"Saved checkpoint to {hps.model_dir}/G_latest.pth and D_latest.pth")
